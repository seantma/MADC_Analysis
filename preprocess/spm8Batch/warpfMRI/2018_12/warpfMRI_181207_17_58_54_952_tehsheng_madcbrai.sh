...
% warpfMRI Script Created on 181207_17_58_54_952

fprintf('Coregistation Script Created on 181207_17_58_54_952\n');
...
UMBatchJobName     = 'warpfMRI_181207_17_58_54_952_tehsheng_madcbrai'
UMBatchProcessName = 'warpfMRI'

warpfMRI_181207_17_58_54_952_tehsheng_madcbrai
...
then
   echo "warpfMRI ${JOBSTATUS}, attempted at : 181207_17_58_54_952" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181207_17_58_54_952 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/warpfMRI -W -w coReg/vbm8 -M ../../Subjects_ASL madc1462_4510 -h t1spgr -v vasc_3dasl -n vbm8_w2mm_ -I PET -B
#
