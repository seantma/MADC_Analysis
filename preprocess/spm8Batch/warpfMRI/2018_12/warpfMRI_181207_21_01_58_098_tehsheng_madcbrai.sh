...
% warpfMRI Script Created on 181207_21_01_58_098

fprintf('Coregistation Script Created on 181207_21_01_58_098\n');
...
UMBatchJobName     = 'warpfMRI_181207_21_01_58_098_tehsheng_madcbrai'
UMBatchProcessName = 'warpfMRI'

warpfMRI_181207_21_01_58_098_tehsheng_madcbrai
...
then
   echo "warpfMRI ${JOBSTATUS}, attempted at : 181207_21_01_58_098" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181207_21_01_58_098 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/warpfMRI -W -w coReg/vbm8 -M ../../Subjects_ASL madc1320_5807 -h t1spgr -v vasc_3dasl -n vbm8_w2mm_ -I PET -B
#
