...
% warpfMRI Script Created on 181210_17_17_06_890

fprintf('Coregistation Script Created on 181210_17_17_06_890\n');
...
UMBatchJobName     = 'warpfMRI_181210_17_17_06_890_tehsheng_madcbrai'
UMBatchProcessName = 'warpfMRI'

warpfMRI_181210_17_17_06_890_tehsheng_madcbrai
...
then
   echo "warpfMRI ${JOBSTATUS}, attempted at : 181210_17_17_06_890" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181210_17_17_06_890 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/warpfMRI -W -w coReg/vbm8 -M ../../Subjects_ASL madc1519_5232 -h t1spgr -v vasc_3dasl -n vbm8_w2mm_ -I PET -B
#
