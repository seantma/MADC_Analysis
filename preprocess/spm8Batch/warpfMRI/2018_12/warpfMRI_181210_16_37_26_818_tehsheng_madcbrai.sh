...
% warpfMRI Script Created on 181210_16_37_26_818

fprintf('Coregistation Script Created on 181210_16_37_26_818\n');
...
UMBatchJobName     = 'warpfMRI_181210_16_37_26_818_tehsheng_madcbrai'
UMBatchProcessName = 'warpfMRI'

warpfMRI_181210_16_37_26_818_tehsheng_madcbrai
...
then
   echo "warpfMRI ${JOBSTATUS}, attempted at : 181210_16_37_26_818" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181210_16_37_26_818 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/warpfMRI -W -w coReg/vbm8 -M ../../Subjects_ASL madc1417_5641 -h t1spgr -v vasc_3dasl -n vbm8_w2mm_ -I PET -B
#
