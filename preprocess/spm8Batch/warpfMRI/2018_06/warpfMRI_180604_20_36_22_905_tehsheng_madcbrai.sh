...
% warpfMRI Script Created on 180604_20_36_22_905

fprintf('Coregistation Script Created on 180604_20_36_22_905\n');
...
UMBatchJobName     = 'warpfMRI_180604_20_36_22_905_tehsheng_madcbrai'
UMBatchProcessName = 'warpfMRI'

warpfMRI_180604_20_36_22_905_tehsheng_madcbrai
...
then
   echo "warpfMRI ${JOBSTATUS}, attempted at : 180604_20_36_22_905" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 180604_20_36_22_905 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/warpfMRI -W -w coReg/vbm8 -M ../../../Subjects_oldResting madc1393_scan1 -h t1mprage -v utprun_ -n vbm8_w3mm_ -I r3mm_avg152T1 -B
#
