...
% warpfMRI Script Created on 181121_13_07_09_388

fprintf('Coregistation Script Created on 181121_13_07_09_388\n');
...
UMBatchJobName     = 'warpfMRI_181121_13_07_09_388_tehsheng_madcbrai'
UMBatchProcessName = 'warpfMRI'

warpfMRI_181121_13_07_09_388_tehsheng_madcbrai
...
then
   echo "warpfMRI ${JOBSTATUS}, attempted at : 181121_13_07_09_388" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_13_07_09_388 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/warpfMRI -W -w coReg/vbm8 -M ../../Subjects_ABCDResting madc0768_scan1 -h t1mprage -v utprun_ -n vbm8_w3mm_ -I r3mm_avg152T1 -B
#
