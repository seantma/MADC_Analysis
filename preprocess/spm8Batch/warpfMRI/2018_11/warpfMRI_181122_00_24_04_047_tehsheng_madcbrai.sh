...
% warpfMRI Script Created on 181122_00_24_04_047

fprintf('Coregistation Script Created on 181122_00_24_04_047\n');
...
UMBatchJobName     = 'warpfMRI_181122_00_24_04_047_tehsheng_madcbrai'
UMBatchProcessName = 'warpfMRI'

warpfMRI_181122_00_24_04_047_tehsheng_madcbrai
...
then
   echo "warpfMRI ${JOBSTATUS}, attempted at : 181122_00_24_04_047" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181122_00_24_04_047 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/warpfMRI -W -w coReg/vbm8 -M ../../Subjects_ABCDResting madc1448_scan1 -h t1mprage -v utprun_ -n vbm8_w3mm_ -I r3mm_avg152T1 -B
#
