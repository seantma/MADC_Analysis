...
% smoothfMRI Script Created on 181208_00_11_37_735

fprintf('Coregistation Script Created on 181208_00_11_37_735\n');
...
UMBatchJobName     = 'smoothfMRI_181208_00_11_37_735_tehsheng_madcbrai'
UMBatchProcessName = 'smoothfMRI'

smoothfMRI_181208_00_11_37_735_tehsheng_madcbrai
...
then
   echo "smoothfMRI ${JOBSTATUS}, attempted at : 181208_00_11_37_735" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181208_00_11_37_735 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/smoothfMRI 5 5 5 -M ../../Subjects_ASL madc1544_5549 -v vbm8_w2mm_vasc_3dasl -n s5 -B
#
