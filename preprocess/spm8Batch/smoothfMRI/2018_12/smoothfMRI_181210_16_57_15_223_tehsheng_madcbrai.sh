...
% smoothfMRI Script Created on 181210_16_57_15_223

fprintf('Coregistation Script Created on 181210_16_57_15_223\n');
...
UMBatchJobName     = 'smoothfMRI_181210_16_57_15_223_tehsheng_madcbrai'
UMBatchProcessName = 'smoothfMRI'

smoothfMRI_181210_16_57_15_223_tehsheng_madcbrai
...
then
   echo "smoothfMRI ${JOBSTATUS}, attempted at : 181210_16_57_15_223" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181210_16_57_15_223 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/smoothfMRI 5 5 5 -M ../../Subjects_ASL madc1458_4524 -v vbm8_w2mm_vasc_3dasl -n s5 -B
#
