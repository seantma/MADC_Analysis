...
% 
% This script is called :  
% /nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/spm8Batch/smoothfMRI/2018_12/smoothfMRI_181207_21_23_25_712_tehsheng_madcbrai.m
% 
% 
% /nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/spm8Batch/smoothfMRI/2018_12/smoothfMRI_181207_21_23_25_712_tehsheng_madcbrai.m
% and create on 181207_21_23_25_712
% 
% 
% and create on 181207_21_23_25_712
...
UMBatchStatusFile = '/nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/madc1519_5232_validation_umstream_status_file';
global UMBatchStatusFile

UMBatchStatusFile = '/nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/madc1575_5746_validation_umstream_status_file';
UMTestFlag    = 0;

UMKernel       = [5 5 5];
UMTestFlag    = 0;
UMVolumeWild   = 'vbm8_w2mm_vasc_3dasl';
UMKernel       = [5 5 5];
UMVolumeExt    = '.*.nii';
UMVolumeWild   = 'vbm8_w2mm_vasc_3dasl';
OutputName     = 's5';
...
UMImgDIRS    = {...
                 {'/nfs/fmri/Analysis/Sean_Working/Subjects_ASL/madc1519_5232/func/run_01'};...
                };
...
% all done.
%
                 {'/nfs/fmri/Analysis/Sean_Working/Subjects_ASL/madc1575_5746/func/run_01'};...
                };
