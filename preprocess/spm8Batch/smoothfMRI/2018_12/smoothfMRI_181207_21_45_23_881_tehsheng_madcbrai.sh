...
% smoothfMRI Script Created on 181207_21_45_23_881

fprintf('Coregistation Script Created on 181207_21_45_23_881\n');
...
UMBatchJobName     = 'smoothfMRI_181207_21_45_23_881_tehsheng_madcbrai'
UMBatchProcessName = 'smoothfMRI'

smoothfMRI_181207_21_45_23_881_tehsheng_madcbrai
...
then
   echo "smoothfMRI ${JOBSTATUS}, attempted at : 181207_21_45_23_881" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181207_21_45_23_881 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/smoothfMRI 5 5 5 -M ../../Subjects_ASL madc1350_5521 -v vbm8_w2mm_vasc_3dasl -n s5 -B
#
