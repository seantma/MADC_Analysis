...
% smoothfMRI Script Created on 181210_16_38_10_433

fprintf('Coregistation Script Created on 181210_16_38_10_433\n');
...
UMBatchJobName     = 'smoothfMRI_181210_16_38_10_433_tehsheng_madcbrai'
UMBatchProcessName = 'smoothfMRI'

smoothfMRI_181210_16_38_10_433_tehsheng_madcbrai
...
then
   echo "smoothfMRI ${JOBSTATUS}, attempted at : 181210_16_38_10_433" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181210_16_38_10_433 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/smoothfMRI 5 5 5 -M ../../Subjects_ASL madc1417_5641 -v vbm8_w2mm_vasc_3dasl -n s5 -B
#
