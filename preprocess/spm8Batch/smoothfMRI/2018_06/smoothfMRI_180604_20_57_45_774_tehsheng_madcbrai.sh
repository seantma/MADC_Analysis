...
% smoothfMRI Script Created on 180604_20_57_45_774

fprintf('Coregistation Script Created on 180604_20_57_45_774\n');
...
UMBatchJobName     = 'smoothfMRI_180604_20_57_45_774_tehsheng_madcbrai'
UMBatchProcessName = 'smoothfMRI'

smoothfMRI_180604_20_57_45_774_tehsheng_madcbrai
...
then
   echo "smoothfMRI ${JOBSTATUS}, attempted at : 180604_20_57_45_774" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 180604_20_57_45_774 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/smoothfMRI 5 5 5 -M ../../../Subjects_oldResting madc1463_scan1 -v vbm8_w3mm_utprun_ -n s5 -B
#
