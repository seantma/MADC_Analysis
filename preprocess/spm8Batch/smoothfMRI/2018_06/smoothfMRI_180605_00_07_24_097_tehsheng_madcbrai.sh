...
% smoothfMRI Script Created on 180605_00_07_24_097

fprintf('Coregistation Script Created on 180605_00_07_24_097\n');
...
UMBatchJobName     = 'smoothfMRI_180605_00_07_24_097_tehsheng_madcbrai'
UMBatchProcessName = 'smoothfMRI'

smoothfMRI_180605_00_07_24_097_tehsheng_madcbrai
...
then
   echo "smoothfMRI ${JOBSTATUS}, attempted at : 180605_00_07_24_097" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 180605_00_07_24_097 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/smoothfMRI 5 5 5 -M ../../../Subjects_oldResting madc1404_scan1 -v vbm8_w3mm_utprun_ -n s5 -B
#
