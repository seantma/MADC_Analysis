...
% smoothfMRI Script Created on 180604_18_56_45_791

fprintf('Coregistation Script Created on 180604_18_56_45_791\n');
...
addpath /nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/spm8Batch/smoothfMRI/2018_06

global UMBatchJobName
global UMBatchProcessName
UMBatchJobName     = 'smoothfMRI_180604_18_56_45_791_tehsheng_madcbrai'
UMBatchProcessName = 'smoothfMRI'

smoothfMRI_180604_18_56_45_791_tehsheng_madcbrai
...
then
   echo "smoothfMRI ${JOBSTATUS}, attempted at : 180604_18_56_45_791" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 180604_18_56_45_791 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/smoothfMRI 5 5 5 -M ../../../Subjects_oldResting madc1382_scan1 -v vbm8_w3mm_utprun_ -n s5 -B
#
