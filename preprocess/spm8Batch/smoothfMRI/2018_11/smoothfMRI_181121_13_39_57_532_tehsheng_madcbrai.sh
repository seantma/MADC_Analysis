...
% smoothfMRI Script Created on 181121_13_39_57_532

fprintf('Coregistation Script Created on 181121_13_39_57_532\n');
...
UMBatchJobName     = 'smoothfMRI_181121_13_39_57_532_tehsheng_madcbrai'
UMBatchProcessName = 'smoothfMRI'

smoothfMRI_181121_13_39_57_532_tehsheng_madcbrai
...
then
   echo "smoothfMRI ${JOBSTATUS}, attempted at : 181121_13_39_57_532" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_13_39_57_532 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/smoothfMRI 5 5 5 -M ../../Subjects_ABCDResting madc0775_scan1 -v vbm8_w3mm_utprun_ -n s5 -B
#
