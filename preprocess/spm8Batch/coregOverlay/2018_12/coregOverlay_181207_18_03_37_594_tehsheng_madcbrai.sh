...
% coregOverlay Script Created on 181207_18_03_37_594

fprintf('Coregistation Script Created on 181207_18_03_37_594\n');
...
UMBatchJobName     = 'coregOverlay_181207_18_03_37_594_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181207_18_03_37_594_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181207_18_03_37_594" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181207_18_03_37_594 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ASL madc1550_5786 -v vasc_3dasl -o t1spgr -B
#
