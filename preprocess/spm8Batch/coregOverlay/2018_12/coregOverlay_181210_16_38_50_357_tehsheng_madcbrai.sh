...
% coregOverlay Script Created on 181210_16_38_50_357

fprintf('Coregistation Script Created on 181210_16_38_50_357\n');
...
UMBatchJobName     = 'coregOverlay_181210_16_38_50_357_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181210_16_38_50_357_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181210_16_38_50_357" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181210_16_38_50_357 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ASL madc1458_4524 -v vasc_3dasl -o t1spgr -B
#
