...
% coregOverlay Script Created on 181207_19_54_00_739

fprintf('Coregistation Script Created on 181207_19_54_00_739\n');
...
UMBatchJobName     = 'coregOverlay_181207_19_54_00_739_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181207_19_54_00_739_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181207_19_54_00_739" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181207_19_54_00_739 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ASL madc1299_5225 -v vasc_3dasl -o t1spgr -B
#
