...
% coregOverlay Script Created on 181207_20_16_48_053

fprintf('Coregistation Script Created on 181207_20_16_48_053\n');
...
UMBatchJobName     = 'coregOverlay_181207_20_16_48_053_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181207_20_16_48_053_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181207_20_16_48_053" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181207_20_16_48_053 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ASL madc1511_5424 -v vasc_3dasl -o t1spgr -B
#
