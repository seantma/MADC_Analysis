...
% coregOverlay Script Created on 181207_20_16_47_833

fprintf('Coregistation Script Created on 181207_20_16_47_833\n');
...
UMBatchJobName     = 'coregOverlay_181207_20_16_47_833_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181207_20_16_47_833_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181207_20_16_47_833" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181207_20_16_47_833 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ASL madc1307_5883 -v vasc_3dasl -o t1spgr -B
#
