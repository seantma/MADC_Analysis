...
% coregOverlay Script Created on 181210_16_57_54_191

fprintf('Coregistation Script Created on 181210_16_57_54_191\n');
...
UMBatchJobName     = 'coregOverlay_181210_16_57_54_191_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181210_16_57_54_191_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181210_16_57_54_191" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181210_16_57_54_191 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ASL madc1519_5232 -v vasc_3dasl -o t1spgr -B
#
