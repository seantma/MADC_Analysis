...
% coregOverlay Script Created on 181207_22_06_20_467

fprintf('Coregistation Script Created on 181207_22_06_20_467\n');
...
UMBatchJobName     = 'coregOverlay_181207_22_06_20_467_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181207_22_06_20_467_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181207_22_06_20_467" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181207_22_06_20_467 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ASL madc1532_5160 -v vasc_3dasl -o t1spgr -B
#
