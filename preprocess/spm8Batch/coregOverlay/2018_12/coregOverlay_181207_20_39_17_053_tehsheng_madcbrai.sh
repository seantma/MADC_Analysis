...
% coregOverlay Script Created on 181207_20_39_17_053

fprintf('Coregistation Script Created on 181207_20_39_17_053\n');
...
UMBatchJobName     = 'coregOverlay_181207_20_39_17_053_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181207_20_39_17_053_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181207_20_39_17_053" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181207_20_39_17_053 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ASL madc1513_5315 -v vasc_3dasl -o t1spgr -B
#
