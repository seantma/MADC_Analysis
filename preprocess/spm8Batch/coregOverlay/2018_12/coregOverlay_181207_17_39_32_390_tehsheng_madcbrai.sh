...
% coregOverlay Script Created on 181207_17_39_32_390

fprintf('Coregistation Script Created on 181207_17_39_32_390\n');
...
UMBatchJobName     = 'coregOverlay_181207_17_39_32_390_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181207_17_39_32_390_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181207_17_39_32_390" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181207_17_39_32_390 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ASL madc1462_4510 -v vasc_3dasl -o t1spgr -B
#
