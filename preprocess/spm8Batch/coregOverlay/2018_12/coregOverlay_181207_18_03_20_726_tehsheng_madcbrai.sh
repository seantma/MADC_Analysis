...
% coregOverlay Script Created on 181207_18_03_20_726

fprintf('Coregistation Script Created on 181207_18_03_20_726\n');
...
UMBatchJobName     = 'coregOverlay_181207_18_03_20_726_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181207_18_03_20_726_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181207_18_03_20_726" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181207_18_03_20_726 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ASL madc1243_4201 -v vasc_3dasl -o t1spgr -B
#
