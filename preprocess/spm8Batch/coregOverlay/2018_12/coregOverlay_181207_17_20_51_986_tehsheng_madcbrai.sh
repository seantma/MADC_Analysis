...
% coregOverlay Script Created on 181207_17_20_51_986

fprintf('Coregistation Script Created on 181207_17_20_51_986\n');
...
UMBatchJobName     = 'coregOverlay_181207_17_20_51_986_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181207_17_20_51_986_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181207_17_20_51_986" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181207_17_20_51_986 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ASL madc1182_5506 -v vasc_3dasl -o t1spgr -B
#
