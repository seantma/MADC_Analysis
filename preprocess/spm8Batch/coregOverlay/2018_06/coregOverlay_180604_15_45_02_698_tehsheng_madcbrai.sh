...
% coregOverlay Script Created on 180604_15_45_02_698

fprintf('Coregistation Script Created on 180604_15_45_02_698\n');
...
UMBatchJobName     = 'coregOverlay_180604_15_45_02_698_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_180604_15_45_02_698_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 180604_15_45_02_698" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 180604_15_45_02_698 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../../Subjects_oldResting madc1446_scan1 -v utprun_ -o t1mprage -B
#
