...
% coregOverlay Script Created on 180605_00_18_50_591

fprintf('Coregistation Script Created on 180605_00_18_50_591\n');
...
UMBatchJobName     = 'coregOverlay_180605_00_18_50_591_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_180605_00_18_50_591_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 180605_00_18_50_591" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 180605_00_18_50_591 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../../Subjects_oldResting madc1271_scan1 -v utprun_ -o t1mprage -B
#
