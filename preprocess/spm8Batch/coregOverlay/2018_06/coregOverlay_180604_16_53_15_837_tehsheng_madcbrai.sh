...
% coregOverlay Script Created on 180604_16_53_15_837

fprintf('Coregistation Script Created on 180604_16_53_15_837\n');
...
UMBatchJobName     = 'coregOverlay_180604_16_53_15_837_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_180604_16_53_15_837_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 180604_16_53_15_837" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 180604_16_53_15_837 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../../Subjects_oldResting madc0775_scan1 -v utprun_ -o t1mprage -B
#
