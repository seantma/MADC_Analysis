...
% coregOverlay Script Created on 180605_00_08_54_550

fprintf('Coregistation Script Created on 180605_00_08_54_550\n');
...
UMBatchJobName     = 'coregOverlay_180605_00_08_54_550_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_180605_00_08_54_550_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 180605_00_08_54_550" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 180605_00_08_54_550 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../../Subjects_oldResting madc1407_scan1 -v utprun_ -o t1mprage -B
#
