...
% coregOverlay Script Created on 180605_00_10_30_799

fprintf('Coregistation Script Created on 180605_00_10_30_799\n');
...
UMBatchJobName     = 'coregOverlay_180605_00_10_30_799_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_180605_00_10_30_799_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 180605_00_10_30_799" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 180605_00_10_30_799 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../../Subjects_oldResting madc1444_scan1 -v utprun_ -o t1mprage -B
#
