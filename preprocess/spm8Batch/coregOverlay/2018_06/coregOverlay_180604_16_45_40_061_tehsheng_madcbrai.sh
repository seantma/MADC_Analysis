...
% coregOverlay Script Created on 180604_16_45_40_061

fprintf('Coregistation Script Created on 180604_16_45_40_061\n');
...
UMBatchJobName     = 'coregOverlay_180604_16_45_40_061_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_180604_16_45_40_061_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 180604_16_45_40_061" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 180604_16_45_40_061 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../../Subjects_oldResting madc1448_scan1 -v utprun_ -o t1mprage -B
#
