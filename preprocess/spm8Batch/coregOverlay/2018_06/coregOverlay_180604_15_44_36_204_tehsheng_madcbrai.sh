...
% coregOverlay Script Created on 180604_15_44_36_204

fprintf('Coregistation Script Created on 180604_15_44_36_204\n');
...
UMBatchJobName     = 'coregOverlay_180604_15_44_36_204_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_180604_15_44_36_204_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 180604_15_44_36_204" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 180604_15_44_36_204 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../../Subjects_oldResting madc0768_scan1 -v utprun_ -o t1mprage -B
#
