...
% coregOverlay Script Created on 180605_00_35_01_592

fprintf('Coregistation Script Created on 180605_00_35_01_592\n');
...
UMBatchJobName     = 'coregOverlay_180605_00_35_01_592_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_180605_00_35_01_592_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 180605_00_35_01_592" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 180605_00_35_01_592 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../../Subjects_oldResting madc1408_scan1 -v utprun_ -o t1mprage -B
#
