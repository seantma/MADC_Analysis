...
% coregOverlay Script Created on 181121_16_43_06_493

fprintf('Coregistation Script Created on 181121_16_43_06_493\n');
...
UMBatchJobName     = 'coregOverlay_181121_16_43_06_493_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181121_16_43_06_493_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181121_16_43_06_493" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_16_43_06_493 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1420_scan1 -v utprun_ -o t1mprage -B
#
