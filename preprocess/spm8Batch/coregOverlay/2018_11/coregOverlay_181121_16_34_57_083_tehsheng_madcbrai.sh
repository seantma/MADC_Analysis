...
% coregOverlay Script Created on 181121_16_34_57_083

fprintf('Coregistation Script Created on 181121_16_34_57_083\n');
...
UMBatchJobName     = 'coregOverlay_181121_16_34_57_083_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181121_16_34_57_083_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181121_16_34_57_083" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_16_34_57_083 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1374_scan1 -v utprun_ -o t1mprage -B
#
