...
% coregOverlay Script Created on 181122_01_35_01_281

fprintf('Coregistation Script Created on 181122_01_35_01_281\n');
...
UMBatchJobName     = 'coregOverlay_181122_01_35_01_281_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181122_01_35_01_281_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181122_01_35_01_281" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181122_01_35_01_281 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1457_scan1 -v utprun_ -o t1mprage -B
#
