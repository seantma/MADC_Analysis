...
% coregOverlay Script Created on 181121_16_17_50_788

fprintf('Coregistation Script Created on 181121_16_17_50_788\n');
...
UMBatchJobName     = 'coregOverlay_181121_16_17_50_788_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181121_16_17_50_788_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181121_16_17_50_788" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_16_17_50_788 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1179_scan1 -v utprun_ -o t1mprage -B
#
