...
% coregOverlay Script Created on 181122_02_34_30_395

fprintf('Coregistation Script Created on 181122_02_34_30_395\n');
...
UMBatchJobName     = 'coregOverlay_181122_02_34_30_395_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181122_02_34_30_395_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181122_02_34_30_395" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181122_02_34_30_395 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1461_scan1 -v utprun_ -o t1mprage -B
#
