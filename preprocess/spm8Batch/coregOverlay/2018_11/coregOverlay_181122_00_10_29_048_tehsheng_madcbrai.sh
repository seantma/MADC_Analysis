...
% coregOverlay Script Created on 181122_00_10_29_048

fprintf('Coregistation Script Created on 181122_00_10_29_048\n');
...
UMBatchJobName     = 'coregOverlay_181122_00_10_29_048_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181122_00_10_29_048_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181122_00_10_29_048" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181122_00_10_29_048 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1403_scan1 -v utprun_ -o t1mprage -B
#
