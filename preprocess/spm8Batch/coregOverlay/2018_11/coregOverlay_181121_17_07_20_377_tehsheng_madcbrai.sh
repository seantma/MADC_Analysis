...
% coregOverlay Script Created on 181121_17_07_20_377

fprintf('Coregistation Script Created on 181121_17_07_20_377\n');
...
UMBatchJobName     = 'coregOverlay_181121_17_07_20_377_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181121_17_07_20_377_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181121_17_07_20_377" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_17_07_20_377 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1421_scan1 -v utprun_ -o t1mprage -B
#
