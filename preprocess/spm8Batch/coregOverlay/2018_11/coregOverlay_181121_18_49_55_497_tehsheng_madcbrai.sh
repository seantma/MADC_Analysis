...
% coregOverlay Script Created on 181121_18_49_55_497

fprintf('Coregistation Script Created on 181121_18_49_55_497\n');
...
addpath /nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/spm8Batch/coregOverlay/2018_11

global UMBatchJobName
global UMBatchProcessName
UMBatchJobName     = 'coregOverlay_181121_18_49_55_497_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181121_18_49_55_497_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181121_18_49_55_497" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_18_49_55_497 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1254_scan1 -v utprun_ -o t1mprage -B
#
