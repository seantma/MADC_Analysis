...
% coregOverlay Script Created on 181126_17_35_08_920

fprintf('Coregistation Script Created on 181126_17_35_08_920\n');
...
UMBatchJobName     = 'coregOverlay_181126_17_35_08_920_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181126_17_35_08_920_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181126_17_35_08_920" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181126_17_35_08_920 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1422_scan1 -v utprun_ -o t1mprage -B
#
