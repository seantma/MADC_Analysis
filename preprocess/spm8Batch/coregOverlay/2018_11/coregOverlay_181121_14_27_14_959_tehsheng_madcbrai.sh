...
% coregOverlay Script Created on 181121_14_27_14_959

fprintf('Coregistation Script Created on 181121_14_27_14_959\n');
...
UMBatchJobName     = 'coregOverlay_181121_14_27_14_959_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181121_14_27_14_959_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181121_14_27_14_959" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_14_27_14_959 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1360_scan1 -v utprun_ -o t1mprage -B
#
