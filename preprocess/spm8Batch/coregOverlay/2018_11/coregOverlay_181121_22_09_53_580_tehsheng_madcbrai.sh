...
% coregOverlay Script Created on 181121_22_09_53_580

fprintf('Coregistation Script Created on 181121_22_09_53_580\n');
...
UMBatchJobName     = 'coregOverlay_181121_22_09_53_580_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181121_22_09_53_580_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181121_22_09_53_580" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_22_09_53_580 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1314_scan1 -v utprun_ -o t1mprage -B
#
