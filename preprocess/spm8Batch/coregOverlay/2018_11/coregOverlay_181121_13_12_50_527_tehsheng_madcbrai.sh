...
% coregOverlay Script Created on 181121_13_12_50_527

fprintf('Coregistation Script Created on 181121_13_12_50_527\n');
...
UMBatchJobName     = 'coregOverlay_181121_13_12_50_527_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181121_13_12_50_527_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181121_13_12_50_527" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_13_12_50_527 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1356_scan1 -v utprun_ -o t1mprage -B
#
