...
% coregOverlay Script Created on 181121_20_05_27_782

fprintf('Coregistation Script Created on 181121_20_05_27_782\n');
...
UMBatchJobName     = 'coregOverlay_181121_20_05_27_782_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181121_20_05_27_782_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181121_20_05_27_782" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_20_05_27_782 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1434_scan1 -v utprun_ -o t1mprage -B
#
