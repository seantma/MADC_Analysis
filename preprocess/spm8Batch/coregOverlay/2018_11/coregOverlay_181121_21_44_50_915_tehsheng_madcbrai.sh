...
% coregOverlay Script Created on 181121_21_44_50_915

fprintf('Coregistation Script Created on 181121_21_44_50_915\n');
...
UMBatchJobName     = 'coregOverlay_181121_21_44_50_915_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181121_21_44_50_915_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181121_21_44_50_915" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_21_44_50_915 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1294_scan1 -v utprun_ -o t1mprage -B
#
