...
% coregOverlay Script Created on 181121_21_21_01_801

fprintf('Coregistation Script Created on 181121_21_21_01_801\n');
...
UMBatchJobName     = 'coregOverlay_181121_21_21_01_801_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181121_21_21_01_801_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181121_21_21_01_801" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_21_21_01_801 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1276_scan1 -v utprun_ -o t1mprage -B
#
