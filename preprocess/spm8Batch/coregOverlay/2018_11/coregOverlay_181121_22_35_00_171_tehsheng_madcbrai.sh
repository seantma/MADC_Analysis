...
% coregOverlay Script Created on 181121_22_35_00_171

fprintf('Coregistation Script Created on 181121_22_35_00_171\n');
...
UMBatchJobName     = 'coregOverlay_181121_22_35_00_171_tehsheng_madcbrai'
UMBatchProcessName = 'coregOverlay'

coregOverlay_181121_22_35_00_171_tehsheng_madcbrai
...
then
   echo "coregOverlay ${JOBSTATUS}, attempted at : 181121_22_35_00_171" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_22_35_00_171 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/coregOverlay -M ../../Subjects_ABCDResting madc1315_scan1 -v utprun_ -o t1mprage -B
#
