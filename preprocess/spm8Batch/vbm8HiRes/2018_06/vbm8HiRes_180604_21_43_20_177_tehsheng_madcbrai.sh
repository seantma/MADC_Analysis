...
#     UMSTREAM_STATUS_FILE      : /nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/madc1250_scan1_validation_umstream_status_file
...
% vbm8HiRes Script Created on 180604_21_43_20_177

fprintf('Coregistation Script Created on 180604_21_43_20_177\n');
...
UMBatchJobName     = 'vbm8HiRes_180604_21_43_20_177_tehsheng_madcbrai'
UMBatchProcessName = 'vbm8HiRes'

vbm8HiRes_180604_21_43_20_177_tehsheng_madcbrai
...
then
    # Make sure that warping job successfully finished
    erodeMask     -E 2     1     -w func/coReg/vbm8          -v vbm8_w3mm_     -h t1mprage     -m "-s 5 -sub 0.333"     -M ../../../Subjects_oldResting     -n eroMask_ madc1250_scan1
else
...
if [ ! -z "/nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/madc1250_scan1_validation_umstream_status_file" ] 
then
   echo "vbm8HiRes ${JOBSTATUS}, attempted at : 180604_21_43_20_177" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 180604_21_43_20_177 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/vbm8HiRes -a func/coReg -w func/coReg/vbm8 -M ../../../Subjects_oldResting madc1250_scan1 -h t1mprage -n vbm8_w3mm_ -I r3mm_avg152T1 -B
#
