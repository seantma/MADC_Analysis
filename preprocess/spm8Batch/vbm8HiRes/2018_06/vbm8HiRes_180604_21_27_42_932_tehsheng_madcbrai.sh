...
#     UMSTREAM_STATUS_FILE      : /nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/madc1357_scan1_validation_umstream_status_file
...
#     UMSTREAM_STATUS_FILE      : /nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/madc1479_scan1_validation_umstream_status_file
...
% vbm8HiRes Script Created on 180604_21_27_42_932
% vbm8HiRes Script Created on 180604_21_27_42_932


fprintf('Coregistation Script Created on 180604_21_27_42_932\n');
fprintf('Coregistation Script Created on 180604_21_27_42_932\n');
...
addpath /Users/rcwelsh/matlabScripts/WELLES/mfiles -END
addpath /nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/spm8Batch/vbm8HiRes/2018_06
addpath /nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/spm8Batch/vbm8HiRes/2018_06
...
global UMBatchProcessName
UMBatchJobName     = 'vbm8HiRes_180604_21_27_42_932_tehsheng_madcbrai'
UMBatchJobName     = 'vbm8HiRes_180604_21_27_42_932_tehsheng_madcbrai'
UMBatchProcessName = 'vbm8HiRes'
UMBatchProcessName = 'vbm8HiRes'


vbm8HiRes_180604_21_27_42_932_tehsheng_madcbrai
vbm8HiRes_180604_21_27_42_932_tehsheng_madcbrai
...
if [ "${MATLAB_RETURN_CODE}" == "0" ]
    erodeMaskthen
    # Make sure that warping job successfully finished
     -E 2    erodeMask     1     -E 2     1     -w func/coReg/vbm8     -w func/coReg/vbm8               -v vbm8_w3mm_     -v vbm8_w3mm_     -h t1mprage     -h t1mprage     -m "-s 5 -sub 0.333"     -m "-s 5 -sub 0.333"     -M ../../../Subjects_oldResting     -M ../../../Subjects_oldResting     -n eroMask_     -n eroMask_ madc1357_scan1 madc1479_scan1
...
if [ ! -z "/nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/madc1357_scan1_validation_umstream_status_file" ] 
if [ ! -z "/nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/madc1479_scan1_validation_umstream_status_file" ] 
then
then
   echo "vbm8HiRes ${JOBSTATUS}, attempted at : 180604_21_27_42_932" >> ${UMSTREAM_STATUS_FILE}
   echo "vbm8HiRes ${JOBSTATUS}, attempted at : 180604_21_27_42_932" >> ${UMSTREAM_STATUS_FILE}
fi
fi
...
#
#
# This job was created on 180604_21_27_42_932 with the command line:
#
#
# This job was created on 180604_21_27_42_932 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/vbm8HiRes -a func/coReg -w func/coReg/vbm8 -M ../../../Subjects_oldResting madc1479_scan1 -h t1mprage -n vbm8_w3mm_ -I r3mm_avg152T1 -B
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/vbm8HiRes -a func/coReg -w func/coReg/vbm8 -M ../../../Subjects_oldResting madc1357_scan1 -h t1mprage -n vbm8_w3mm_ -I r3mm_avg152T1 -B
#
#
