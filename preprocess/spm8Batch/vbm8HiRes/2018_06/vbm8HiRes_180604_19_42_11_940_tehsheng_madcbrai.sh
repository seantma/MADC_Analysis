...
% vbm8HiRes Script Created on 180604_19_42_11_940

fprintf('Coregistation Script Created on 180604_19_42_11_940\n');
...
UMBatchJobName     = 'vbm8HiRes_180604_19_42_11_940_tehsheng_madcbrai'
UMBatchProcessName = 'vbm8HiRes'

vbm8HiRes_180604_19_42_11_940_tehsheng_madcbrai
...
then
    # Make sure that warping job successfully finished
    erodeMask     -E 2     1     -w func/coReg/vbm8          -v vbm8_w3mm_     -h t1mprage     -m "-s 5 -sub 0.333"     -M ../../../Subjects_oldResting     -n eroMask_ madc1461_scan1
else
...
then
   echo "vbm8HiRes ${JOBSTATUS}, attempted at : 180604_19_42_11_940" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 180604_19_42_11_940 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/vbm8HiRes -a func/coReg -w func/coReg/vbm8 -M ../../../Subjects_oldResting madc1461_scan1 -h t1mprage -n vbm8_w3mm_ -I r3mm_avg152T1 -B
#
