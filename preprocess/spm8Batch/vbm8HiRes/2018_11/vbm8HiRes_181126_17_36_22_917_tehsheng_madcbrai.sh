...
% vbm8HiRes Script Created on 181126_17_36_22_917

fprintf('Coregistation Script Created on 181126_17_36_22_917\n');
...
UMBatchJobName     = 'vbm8HiRes_181126_17_36_22_917_tehsheng_madcbrai'
UMBatchProcessName = 'vbm8HiRes'

vbm8HiRes_181126_17_36_22_917_tehsheng_madcbrai
...
then
    # Make sure that warping job successfully finished
    erodeMask     -E 2     1     -w func/coReg/vbm8          -v vbm8_w3mm_     -h t1mprage     -m "-s 5 -sub 0.333"     -M ../../Subjects_ABCDResting     -n eroMask_ madc1422_scan1
else
...
then
   echo "vbm8HiRes ${JOBSTATUS}, attempted at : 181126_17_36_22_917" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181126_17_36_22_917 with the command line:
#
