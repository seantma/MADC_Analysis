...
% vbm8HiRes Script Created on 181126_16_30_21_341

fprintf('Coregistation Script Created on 181126_16_30_21_341\n');
...
UMBatchJobName     = 'vbm8HiRes_181126_16_30_21_341_tehsheng_madcbrai'
UMBatchProcessName = 'vbm8HiRes'

vbm8HiRes_181126_16_30_21_341_tehsheng_madcbrai
...
then
    # Make sure that warping job successfully finished
    erodeMask     -E 2     1     -w func/coReg/vbm8          -v vbm8_w3mm_     -h t1mprage     -m "-s 5 -sub 0.333"     -M ../../Subjects_ABCDResting     -n eroMask_ madc1228_scan1
else
...
then
   echo "vbm8HiRes ${JOBSTATUS}, attempted at : 181126_16_30_21_341" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181126_16_30_21_341 with the command line:
#
