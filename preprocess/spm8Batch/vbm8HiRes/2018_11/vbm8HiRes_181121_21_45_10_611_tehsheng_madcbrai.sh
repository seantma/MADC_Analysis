...
% vbm8HiRes Script Created on 181121_21_45_10_611

fprintf('Coregistation Script Created on 181121_21_45_10_611\n');
...
UMBatchJobName     = 'vbm8HiRes_181121_21_45_10_611_tehsheng_madcbrai'
UMBatchProcessName = 'vbm8HiRes'

vbm8HiRes_181121_21_45_10_611_tehsheng_madcbrai
...
then
    # Make sure that warping job successfully finished
    erodeMask     -E 2     1     -w func/coReg/vbm8          -v vbm8_w3mm_     -h t1mprage     -m "-s 5 -sub 0.333"     -M ../../Subjects_ABCDResting     -n eroMask_ madc1440_scan1
else
...
then
   echo "vbm8HiRes ${JOBSTATUS}, attempted at : 181121_21_45_10_611" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181121_21_45_10_611 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/vbm8HiRes -a func/coReg -w func/coReg/vbm8 -M ../../Subjects_ABCDResting madc1440_scan1 -h t1mprage -n vbm8_w3mm_ -I r3mm_avg152T1 -B
#
