...
#     UMSTREAM_STATUS_FILE      : /nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/madc1220_3783_validation_umstream_status_file
...
% vbm8HiRes Script Created on 181207_17_42_13_125

fprintf('Coregistation Script Created on 181207_17_42_13_125\n');
...
UMBatchJobName     = 'vbm8HiRes_181207_17_42_13_125_tehsheng_madcbrai'
UMBatchProcessName = 'vbm8HiRes'

vbm8HiRes_181207_17_42_13_125_tehsheng_madcbrai
...
then
    # Make sure that warping job successfully finished
    erodeMask     -E 2     1     -w func/coReg/vbm8          -v vbm8_w2mm_     -h t1spgr     -m "-s 5 -sub 0.333"     -M ../../Subjects_ASL     -n eroMask_ madc1220_3783
else
...
if [ ! -z "/nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/madc1220_3783_validation_umstream_status_file" ] 
then
   echo "vbm8HiRes ${JOBSTATUS}, attempted at : 181207_17_42_13_125" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181207_17_42_13_125 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/vbm8HiRes -a func/coReg -w func/coReg/vbm8 -M ../../Subjects_ASL madc1220_3783 -h t1spgr -n vbm8_w2mm_ -I PET -B
#
