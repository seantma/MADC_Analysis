...
% vbm8HiRes Script Created on 181210_16_19_26_815

fprintf('Coregistation Script Created on 181210_16_19_26_815\n');
...
UMBatchJobName     = 'vbm8HiRes_181210_16_19_26_815_tehsheng_madcbrai'
UMBatchProcessName = 'vbm8HiRes'

vbm8HiRes_181210_16_19_26_815_tehsheng_madcbrai
...
then
    # Make sure that warping job successfully finished
    erodeMask     -E 2     1     -w func/coReg/vbm8          -v vbm8_w2mm_     -h t1spgr     -m "-s 5 -sub 0.333"     -M ../../Subjects_ASL     -n eroMask_ madc1417_5641
else
...
then
   echo "vbm8HiRes ${JOBSTATUS}, attempted at : 181210_16_19_26_815" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181210_16_19_26_815 with the command line:
#
