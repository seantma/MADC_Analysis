...
% vbm8HiRes Script Created on 181207_23_32_46_251

fprintf('Coregistation Script Created on 181207_23_32_46_251\n');
...
UMBatchJobName     = 'vbm8HiRes_181207_23_32_46_251_tehsheng_madcbrai'
UMBatchProcessName = 'vbm8HiRes'

vbm8HiRes_181207_23_32_46_251_tehsheng_madcbrai
...
then
    # Make sure that warping job successfully finished
    erodeMask     -E 2     1     -w func/coReg/vbm8          -v vbm8_w2mm_     -h t1spgr     -m "-s 5 -sub 0.333"     -M ../../Subjects_ASL     -n eroMask_ madc1543_5181
else
...
then
   echo "vbm8HiRes ${JOBSTATUS}, attempted at : 181207_23_32_46_251" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181207_23_32_46_251 with the command line:
#
