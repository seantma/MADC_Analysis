...
#     UMSTREAM_STATUS_FILE      : /nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/madc1549_5224_validation_umstream_status_file
...
% vbm8HiRes Script Created on 181208_00_33_04_614

fprintf('Coregistation Script Created on 181208_00_33_04_614\n');
...
UMBatchJobName     = 'vbm8HiRes_181208_00_33_04_614_tehsheng_madcbrai'
UMBatchProcessName = 'vbm8HiRes'

vbm8HiRes_181208_00_33_04_614_tehsheng_madcbrai
...
then
    # Make sure that warping job successfully finished
    erodeMask     -E 2     1     -w func/coReg/vbm8          -v vbm8_w2mm_     -h t1spgr     -m "-s 5 -sub 0.333"     -M ../../Subjects_ASL     -n eroMask_ madc1549_5224
else
...
if [ ! -z "/nfs/fmri/Analysis/Sean_Working/Git_MADC/preprocess/madc1549_5224_validation_umstream_status_file" ] 
then
   echo "vbm8HiRes ${JOBSTATUS}, attempted at : 181208_00_33_04_614" >> ${UMSTREAM_STATUS_FILE}
fi
...
#
#
# This job was created on 181208_00_33_04_614 with the command line:
#
# /nfs/psych-bhampstelab/VA_SPiRE_2015/fMRI_Working/MCore/spm8Batch/vbm8HiRes -a func/coReg -w func/coReg/vbm8 -M ../../Subjects_ASL madc1549_5224 -h t1spgr -n vbm8_w2mm_ -I PET -B
#
