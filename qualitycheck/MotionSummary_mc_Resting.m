...
% Model = 'Case1_Case2_Resting_despike';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
MotionPathTemplate = '[Exp]/Subjects_oldResting/[Subject]/func/[Run]/realign.dat';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
OutputCensorVector = '[Exp]/Subjects_oldResting/[Subject]/func/[Run]/CensorVector';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
OutputPlotPath = '[Exp]/Subjects_oldResting/[Subject]/func/';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PreRealignTemplate = '[Exp]/Subjects_oldResting/[Subject]/func/[Run]/trun*.nii';
...
% Sean:: creating Diary
diary('MotionCheck_Matlab_Console_Resting_output.txt')
