...
DespikeParametersTemplate = ...
    '[Exp]/Subjects_oldResting/[Subject]/func/[Run]/prefilter_despike.dat';
DespikeReplacementOption  = 'sgolay7';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
OutputTemplate  = '[Exp]/Scott_CPM_oldResting/[Subject]/[OutputName]/';
...
diary(strcat('ConnTool_Matlab_Console_output_', OutputName, '.txt'))
