...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ImageTemplate = '[Exp]/Subjects_ABCDResting/[Subject]/func/[Run]';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
TR = 1.0;   %!!NOTE:: ABCD Resting has TR=1.0s NOT 0.9s!!
...
%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
AnatomyMaskPath = '[Exp]/Subjects_ABCDResting/[Subject]/func/coReg/vbm8/';
...
RealignmentParametersTemplate = ...
    '[Exp]/Subjects_ABCDResting/[Subject]/func/[Run]/realign.dat';
    % '[Exp]/Subjects_ABCDResting/[Subject]/func/[Run]/mcflirt*a8*.dat';
...
DespikeParametersTemplate = ...
    '[Exp]/Subjects_ABCDResting/[Subject]/func/[Run]/prefilter_despike.dat';
DespikeReplacementOption  = 'sgolay7';
...
CensorParametersTemplate = ...
    '[Exp]/Subjects_ABCDResting/[Subject]/func/[Run]/CensorVector.mat';
...
%%% NOTE - If runing in ALFF or fALFF mode, you can not do censoring (edit by removal)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
RegressOrder = 'DMCWBE'; %SEAN changed from DSMCWB - which used despiking instead of scrubbing
...
%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ROICenters = load('PP264_ROIs_All_Sean_amyhippo.csv')   % original file from /ftools
ROISize    = {19};    %Graph_P264_sort_amyhippo_27vx
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
OutputTemplate  = '[Exp]/FirstLevel_ABCDResting/[Subject]/[OutputName]/';
OutputName      = 'Graph_P264_MTL_19vx';
% 'Graph_P264_MTL_19vx'; FD=0.5, Power264 + amyg/hippo, scrubbing, 19 vx ROIs
...
diary(strcat('ConnTool_Matlab_Console_ABCDResting_', OutputName, '.txt'))
